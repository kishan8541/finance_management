...
if($password != $cnfpassword){
	echo '<script>alert("pls fill same password")</script>';
}

if(isset($_POST['reset'])){
	$updatedData = mysqli_query($config,"UPDATE admin_details SET password = '$password', cnfpassword = '$cnfpassword' WHERE email = '$email'");
	if($updatedData){
		echo '<script>echo("data updated")</script>';
