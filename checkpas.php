<?php
// include('master_page/master_header.php');
// include('master_page/master_sidebar.php');
session_start();
...
<body>
                    ...
                    <div class="login-right">
                        <div class="login-right-wrap">
                            ...
                            <form method="post">
                                ...
                                <div class="form-group">
                                    <button class="btn btn-primary btn-block" type="submit" name="reset">Reset My Password</button>
                                </div>
    ...
    <script src="<?php echo $base_url;?>modules/assets/js/jquery-3.7.1.min.js" type="37e407c9de6830687d73883f-text/javascript"></script>

    <script src="<?php echo $base_url;?>modules/assets/js/bootstrap.bundle.min.js" type="37e407c9de6830687d73883f-text/javascript"></script>

    <script src="<?php echo $base_url;?>modules/assets/js/feather.min.js" type="37e407c9de6830687d73883f-text/javascript"></script>

    <script src="<?php echo $base_url;?>modules/assets/js/script.js" type="37e407c9de6830687d73883f-text/javascript"></script>
    <script src="<?php echo $base_url;?>modules/assets/js/rocket-loader.min.js"
        data-cf-settings="37e407c9de6830687d73883f-|49" defer></script>
</body>
...
if(empty($email)){
    echo '<script>alert("pls fill the email id")</script>';
    return;
}
...
if(isset($_POST['reset'])){
    $selectedData = mysqli_query($config,"SELECT * FROM admin_details WHERE email = '$email'");
    if(mysqli_num_rows($selectedData) > 0){
        ...
        echo '<script>alert("pls write correct email")</script>';
    }
}
?>